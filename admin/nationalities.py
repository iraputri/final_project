...
class TestLogin(unittest.TestCase): 
    ...
    def test_b_success_add_nationality(self): 
        # steps
        ...
        browser.get("https://opensource-demo.orangehrmlive.com/index.php/admin/nationality") # buka halaman
        browser.find_element(By.ID,"btnAdd").click() # klik tombol add
        browser.find_element(By.ID, "nationality_name").send_keys("Ireland") # isi value
    ...
    def test_c_success_update_nationality(self): 
        # steps
        browser = self.browser #buka web browser
        browser.get("https://opensource-demo.orangehrmlive.com") # buka situs
        time.sleep(3)
        ...
        browser.get("https://opensource-demo.orangehrmlive.com/index.php/admin/nationality") # buka halaman
        time.sleep(3)
        browser.find_element(By.XPATH, '//a[text()="Ireland"]').click()
        time.sleep(1)
        browser.find_element(By.ID, "nationality_name").clear() # clear value
        browser.find_element(By.ID, "nationality_name").send_keys("New Ireland") # isi value
